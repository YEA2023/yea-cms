...
return (
  <>
    ...
    <footer className="dark-footer skin-dark-footer style-2">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 283.5 27.8" preserveAspectRatio="none" className="footer-shape">
        ...
        <div className="row">
          <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12">
            <div className="footer_widget">
              <img src="/assets/images/yea-logo.png" className="img-footer small mb-2" alt="" />
          ...
          <div className="footer_widget">
              ...
              <div className="address mt-2"> <i className="lni lni-map-marker"></i> Meghanor, Plot No. 811, Road No. 41, Jubilee Hills, Hyderabad - 500 033 India </div>
              <div className="address mt-3"> <i className="lni lni-envelope"></i> info@yeaindia.org </div>
  ...
  {/* <div className="footer-nav-area d-md-none" id="footerNav">
        <div className="suha-footer-nav">
          <ul className="d-flex align-items-center justify-content-between px-0 d-flex rtl-flex-d-row-r py-2">
            <li><a href="/"><i className="fa fa-home" />Home</a></li>
            <li><a href="#"><i className="fa fa-address-book" />Business</a></li>
            <li><a href="#"><i className="fa fa-users" />Memebers</a></li>            
            <li><a href="#"><i className="fa fa-heart" />Events</a></li>
